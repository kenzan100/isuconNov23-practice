...
task :bench do
  ...
  exec HOSTS[:host01], "alp ltsv --file=/home/isucon/access.log -r --sort=sum --output='count,method,uri,sum' -m '/api/condition/[0-9a-z\-]+$,/api/condition/[0-9a-z\-]/icon$,/api/condition/[0-9a-z\-]/graph$,/api/isu/[0-9a-z\-]+$,/api/isu/[0-9a-z\-]+/icon$,/api/isu/[0-9a-z\-]+/graph$,/isu/[0-9a-z\-]+/condition$,/isu/[0-9a-z\-]+/graph$,/isu/[0-9a-z\-]+$' --format html > /tmp/alp/#{timestamp}.html"
